...
class RecommendationServiceImplTest {
    ...
    @Mock private FarmActivityRepository activityRepository;
    @Mock private WeatherService weatherService;
    @Mock private CropAgeService cropAgeService;
    @Mock private OpenAiWordingService openAiWordingService;
    ...
    void setUp() {
        recommendationService = new RecommendationServiceImpl(
                fieldRepository, activityRepository, weatherService, cropAgeService,
                openAiWordingService, historyRepository
        );
    }
    ...
    void shouldReturnHighRiskWhenHumidityRainAndSprayDelayAreHigh() {
        ...
        when(openAiWordingService.buildFarmerAdvisory(any(), any())).thenReturn(Optional.empty());
    ...
    private FarmField buildField(Long id, LocalDate sowingDate) {
        ...
        field.setId(id); field.setFieldName("Field " + id);
        field.setCropName("Wheat"); field.setSowingDate(sowingDate);
        return field;
    }
}